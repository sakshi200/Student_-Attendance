...
{
char name[30];
printf("Enter student name to remove: "); fflush(stdin);
gets(name);
...
{
printf("\n**********MainMenu***********\n");
 printf("Enter 1 foradd student\n");
   printf("Enter 2 for takeattendance\n");
printf("Enter 3 for checkattendance\n");
printf("Enter 4 for removestudent\n");
